...
"""think this looks really good after some testing"""
"""validation idea is tto transform new view back to original position, and see if looks the same. i.e. how much info do we lose in the discretising"""
